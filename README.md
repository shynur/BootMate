...
- [代码结构分析](https://blog.csdn.net/qq_66550041/article/details/122606740): 原文发表于 CSDN, 防止它哪天倒闭, 现将其复制到本仓库的 [`COMMENTARY.txt`](COMMENTARY.txt) 文件.  同样地, 该文与本仓库中的实际代码有些许出入, 因为代码 (和文件名) 后来经过些微的修改.
